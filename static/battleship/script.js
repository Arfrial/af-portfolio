...
function setCommander(state) {
  commander.src = `/static/battleship/commander/${state}.png`;
}
...
const sounds = {
  hit: new Audio("/static/battleship/sounds/hit.mp3"),
  miss: new Audio("/static/battleship/sounds/miss_V2.mp3"),
  place: new Audio("/static/battleship/sounds/place_v3.mp3"),
  win: new Audio("/static/battleship/sounds/win.mp3"),
  lose: new Audio("/static/battleship/sounds/lose.mp3"),
};
...
function endGame(playerWon) {
  ...
  if (playerWon) {
    winnerCommander.src = "/static/battleship/commander/win.png";
    setCommander("win");
    winnerText.textContent = `Victory, Captain ${username}!`;
    typeStatus("Enemy fleet destroyed. Victory!");
    playSound("win");
  } else {
    winnerCommander.src = "/static/battleship/commander/lose_V2.png";
    setCommander("lose");
